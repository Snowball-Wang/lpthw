...
class Engine(object):
	...
	def play(self):
		current_scene = self.scene_map.opening_scene()   #打开当前游戏场景
                #print current_scene
		
		while True:
			print "\n-----------"
			next_scene_name = current_scene.enter()                    #进入游戏，并将此游戏场景的返回值赋值给下一个游戏场景
			#print next_scene_name
			current_scene = self.scene_map.next_scene(next_scene_name) #将下一个游戏场景的赋值为当前游戏场景，实现游戏场景切换
...
class CentralCorridor(Scene):
	...
	def enter(self):
		print """
			...
			to get the neutron destruct bomb from the Weapons Armory, put it in the bridge,
			...
			about to pull a weapon to blast you."""
                ...
                if action == "shoot!":
                    print """
                        ...
                        His clown costume is flowing and moving around his body, which throws off your 
                        aim. Your laser hits his costume but misses him entirely. This completely ruins
                        his brand new costume his mother bought him, which makes him fly into a rage and 
                    ...
                    print """
                        ...
                        tell the one Gothon joke you know: lba;fjdkjkfafdfajfdklsa. The Gothon stops,
                        tries not to laugh, then busts out laughing and can't move. While he's laughing 
                        you run up and shoot him square in the head putting him down, then jump through
                        the Weapons Armory door."""
		...
		while guess != code and guesses < 10:
                ...
                if guess == code:
                        print """
                                ...
                                You grap the neutron bomb and run as fast as you can to the bridge
...
class TheBridge(Scene):
	...
	def enter(self):
		...
		if action == "throw the bomb":
                        print """
                                In a panic you throw the bomb at the group of Gothons and make a
                                leap for the door. Right as you drop it a Gothon shoots you right
                                in the back killing you. As you die you see another Gothon frantically
                                try to disarm the bomb. You die knowing they will probably blow up
                                when it goes off.
                                """
                        return 'death'
	...
	def enter(self):
		...
		if int(guess) != good_pod:
                        ...
                        print """
                                ...
                                you look back and see your ship implode then explode like a bright star,
...
class Map(object):
        ...
        ## scenes是一个dict，实现游戏场景名称和实际游戏场景函数的对应
	scenes = {
...
a_map = Map('central_corridor')  #启动地图，初始地图为central_corridor
a_game = Engine(a_map)           #启动游戏引擎
a_game.play()                    #进入游戏
